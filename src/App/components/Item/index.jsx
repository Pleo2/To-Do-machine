  ...
  return (
    ...
    >
      <motion.span
        ...
        onClick={onComplete}
      >
        {!completed && <CircleSVG title='CircleSVG' width="16" height="16" /> }
        {completed && <CheckCircleSVG title='CheckCircleSVG' width="16" height="16" /> }
      </motion.span>
      ...
      <motion.span
        ...
        onClick={onDelete}
      >
        <TrashSVG title='TrashSVG' key={logoId()} />
      </motion.span>
    </motion.li>
  );
}
